...
urlpatterns = [
    ...
    path(
        "employees/<int:pk>/", EmployeeRetrieveAPIView.as_view(),
    ...
    path("employees/busy/",
         BusyEmployeesListAPIView.as_view(),
         name="busy-employees"),
    path("tasks/", TaskListAPIView.as_view(),
         name="task-list"),
    path("tasks/create/", TaskCreateAPIView.as_view(),
         name="task-create"),
    path("tasks/<int:pk>/", TaskRetrieveAPIView.as_view(),
         name="task-detail"),
    path("tasks/<int:pk>/update/", TaskUpdateAPIView.as_view(),
         name="task-update"),
    path("tasks/<int:pk>/delete/", TaskDestroyAPIView.as_view(),
         name="task-delete"),
    path(
        "tasks/important/", ImportantTasksListAPIView.as_view(),
