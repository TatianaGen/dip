...
class EmployeeUpdateAPIViewTestCase(APITestCase):
    def setUp(self):
        ...
        self.url = reverse(
            "task_tracker:employee-update", kwargs={"pk": self.employee.pk}
        )
        self.valid_data = {
...
class TaskRetrieveAPIViewTestCase(APITestCase):
    def setUp(self):
        ...
        self.url = reverse("task_tracker:task-detail",
...
class TaskUpdateAPIViewTestCase(APITestCase):
    def setUp(self):
        ...
        self.url = reverse("task_tracker:task-update",
                           kwargs={"pk": self.task.pk})
        self.valid_data = {
            "name": "Updated Task",
            "assignee": self.employee.id,
...
class TaskDestroyAPIViewTestCase \
            (APITestCase):
    def setUp(self):
        self.employee = (Employee.objects.create(
            full_name="John Doe", position="Developer",
...
class TaskFilterAPIViewTestCase \
            (APITestCase):
    def setUp(self):
        self.employee = Employee.objects.create(
            full_name="John Doe", position="Developer",
